...
class VariedCoefficientsExperiment(Experiment):
    """
    Vary the coefficients used.
    """

    experiment_name = "var-coef"
    sae_variant = SAEVariant.STANDARD
    n_features = tuple(64 * n for n in (8, 8, 32, 64, 64))
    ...
    # Regularization parameters
    regularization_max_steps = 15000
    regularization_coefficient = torch.tensor([2500.0, 2500.0, 10000.0, 10000.0, 10000.0])
    regularization_l1_coefficients = (0.002, 0.006, 0.036, 0.04, 0.045)  # Targets l0s ~ 10
    regularization_trainable_layers = (0, 1, 2, 3, 4)
